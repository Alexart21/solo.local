...
history.replaceState(null,null,newHash);}});});$(window).resize(function(){$respTabs.find('.resp-accordion-closed').removeAttr('style');});});}});})(jQuery);;(function(){var isiPad=function(){return(navigator.platform.indexOf("iPad")!=-1);}
